...
const LoginPage = () => {
  ...
  return (
    <main className="bg-[#F7F9FA] w-full min-h-screen flex justify-center items-center">
      <div className="max-w-136 w-full bg-white rounded-xl border-t-4 border-primary-blue py-12 px-[72px]">
        <Image
        ...
        <Button
          className="w-full rounded-lg! mb-8 bg-blue-tint-100 hover:bg-blue-tint-200 text-primary-blue font-semibold py-3"
