...
const ProductDetail = () => {
  return (
    <main className="container mx-auto py-40 flex gap-12">
      <div className="bg-blue-tint aspect-square min-w-140 flex justify-center items-center">
        <Image
      ...
      <div className="w-full py-7">
        ...
        <div className="bg-blue-tint rounded-full text-primary-blue py-2 px-6 w-fit mb-5">
          Football
        </div>
        ...
        <div className="text-primary-blue text-[32px] font-semibold mb-12">
